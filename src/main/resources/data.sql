...
--ユーザーテーブルデータ
INSERT INTO customers(name,address,tel,email,password,birthday) VALUES('鈴木一郎','東京都渋谷区','000-111-222','suzuki@aaa.com','himitu','2000-8-5');
INSERT INTO customers(name,address,tel,email,password,birthday) VALUES('佐藤花子','神奈川県相模原市','111-222-333','sato@aaa.com','himitu','2000-12-16');
INSERT INTO customers(name,address,tel,email,password,birthday) VALUES('田中太郎','千葉県浦安市','222-333-444','tanaka@aaa.com','himitu','2000-09-30');
